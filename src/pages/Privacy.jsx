function Privacy() {
  return (
    <div className="mx-auto mt-5 max-w-7xl px-5">
      ...
      <h4 className=" text-primaryDark mt-6">
        <span className="font-semibold">Prem Seva Privacy Policy</span>
      </h4>
      <div className="mt-5">
      ...
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Interpretation and Definitions</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          Application refers to Prem Seva , the software program provided by the
          Company. Company (referred to as either "the Company", "We", "Us" or
          "Our" in this Agreement) refers to Ms Prem Seva , Sahil Shikharewadi
          Nashik Road 422101 . Cookies are small files that are placed on Your
          computer, mobile device or any other device by a website, containing
          the details of Your browsing history on that website among its many
          uses. Country refers to: Maharashtra, India Device means any device
          ...
          Application or the Website or both. Service Provider means any natural
          ...
          which a User can log in or create an account to use the Service. Usage
          ...
          premseva.com, accessible from http://www.premseva.com You means the
      ...
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          <br />● Google <br />● Facebook <br />● Instagram <br />● Twitter{" "}
          <br />● LinkedIn If You decide to register through or otherwise grant
      ...
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          Information regarding your location <br />● Information from your
          Device's phone book (contacts list) <br />● Pictures and other
          information from your Device's camera and photo library We use this
      ...
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Tracking Technologies and Cookies</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          include: <br />● Cookies or Browser Cookies. A cookie is a small file
          ...
          refuse Cookies, our Service may use Cookies. <br />● Web Beacons.
          ...
          Policy website article. We use both Session and Persistent Cookies for
      ...
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          in the following situations: <br />● With Service Providers: We may
          share Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You. <br />● For business
          transfers: We may share or transfer Your personal information in
          connection with, or during negotiations of, any merger, sale of
          Company assets, financing, or acquisition of all or a portion of Our
          business to another company. <br />● With Affiliates: We may share
          ...
          Us. <br />● With business partners: We may share Your information with
          Our business partners to offer You certain products, services or
          promotions. <br />● With other users: when You share personal
          ...
          Your profile. <br />● With Your consent: We may disclose Your personal
          information for any other purpose with Your consent.
        </p>
        <br />
      </div>{" "}
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Retention of Your Personal Data</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Transfer of Your Personal Data</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <br />
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Delete Your Personal Data</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <br />
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Law enforcement</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <br />
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Other legal requirements</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
          ...
          <br />● Prevent or investigate possible wrongdoing in connection with
          the Service
          <br />● Protect the personal safety of Users of the Service or the
          public
      ...
      <br />
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Security of Your Personal Data</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <br />
      <h4 className=" text-primaryDark ">
        <span className="font-semibold">Links to Other Websites</span>
      </h4>
      <div className="mt-5">
        <p className="text-sm text-gray-500">
      ...
      <div className="mt-5">
        ...
        <p className="text-sm font-medium text-[#0566B1] ">
          By email: <span className="underline">premsevateam@gmail.com</span>
        </p>
        <p className="text-sm font-medium text-[#0566B1]">
          By visiting this page on our website:{" "}
          <span className="underline">premseva.com</span>
        </p>
      </div>
    </div>
  );
